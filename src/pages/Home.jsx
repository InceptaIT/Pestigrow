...
// // import products from "../data/products"; // Assuming this is no longer needed in this component
// import heroImg from "../assets/images/hero5.jpg";
// import fungicideIcon from "../assets/images/fungicide.jpg";
// import insecticideIcon from "../assets/images/insecticide1.jpg";
// import herbicideIcon from "../assets/images/herbicide1.jpg";
// import plantGrowthIcon from "../assets/images/PGR1.jpg";
...
//       className="relative rounded-xl shadow-xl p-8 bg-white border border-gray-100 flex flex-col items-center text-center min-h-[450px] overflow-hidden font-sans"
//       whileHover={{ y: -5, boxShadow: "0 15px 30px -5px rgba(0, 0, 0, 0.15)" }}
//       transition={{ type: "spring", stiffness: 300 }}
//       variants={itemVariants} // Added variants here for stagger animation
//     >
//       <motion.div
...
//       <h3
//         className={`text-3xl font-bold font-sans mb-3 leading-tight ${color}`}
//       >
//         {title}
//       </h3>

//       <p className="text-lg text-[#4a5568] mb-8 flex-grow font-sans">
//         {description}
//       </p>

//       {/* Dynamic Button with Smooth Transition */}
//       <Link
//         to={`/products?category=${category}`}
//         className="mt-auto bg-[#1b5e20] text-white px-6 py-4 rounded-full font-semibold
//                   hover:bg-[#2e7d32] transition-all duration-300 ease-in-out inline-flex items-center shadow-md font-sans text-lg"
//       >
//         <AnimatePresence mode="wait" initial={false}>
//           {!isHovered ? (
//             // Initial state: Only Arrow
//             <motion.div
//               key="arrow"
...
// const HomePage = () => {
//   return (
//     <div className="bg-secondary text-textDark font-sans">
//       <section
//         className="relative h-[70vh]   md:h-[85vh] bg-contain bg-center flex items-center justify-center text-center"
//         style={{
...
//         }}
//       >
//         <div className="absolute inset-0 bg-gradient-to-br from-[#1b5e20]/0 to-[#2e7d32]/0"></div>
...
//               className="text-[#e8f5e8] drop-shadow-2xl pb-2 bg-gradient-to-r from-[#51d551] to-[#1b5e20] bg-clip-text text-transparent inline-block"
//             >
//               Pestigrow
//             </motion.span>
//           </h1>
...
//           >
//             <span className="text-[#e8f5e8] font-medium">
...
//                 {/* New Main Animation - Growing Plant */}
//                 <motion.div
...
//               <motion.h2
//                 variants={itemVariants}
//                 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#1b5e20] mb-4 md:mb-6 font-sans leading-tight"
//               >
//                 <motion.span
...
//               <motion.p
//                 variants={itemVariants}
//                 className="text-base sm:text-lg md:text-xl text-[#2d3748] mb-6 md:mb-8 leading-relaxed font-light font-sans"
//                 initial={{ opacity: 0 }}
//                 animate={{ opacity: 1 }}
...
//               <motion.p
//                 variants={itemVariants}
//                 className="text-base sm:text-lg md:text-xl text-[#1b5e20] mb-8 md:mb-10 leading-relaxed font-semibold italic font-sans"
...
//                   <Link
//                     to="/about"
//                     className="group bg-gradient-to-r from-[#1b5e20] to-[#2e7d32] text-white px-6 py-3 md:px-8 md:py-4 rounded-full font-bold hover:shadow-2xl transition-all duration-300 inline-flex items-center justify-center shadow-lg font-sans text-sm md:text-base w-full sm:w-auto text-center"
//                   >
...
//                   <Link
//                     to="/contact"
//                     className="group bg-white/90 backdrop-blur-sm text-[#1b5e20] border-2 border-[#1b5e20] px-6 py-3 md:px-8 md:py-4 rounded-full font-bold hover:bg-[#1b5e20] hover:text-white transition-all duration-300 inline-flex items-center justify-center shadow-lg font-sans text-sm md:text-base w-full sm:w-auto text-center"
//                   >
...
//       {/* Mission & Core Values Section (Unchanged) */}
//       <motion.section
...
//           <motion.h2
//             variants={itemVariants}
//             className="text-3xl md:text-4xl lg:text-5xl  font-bold text-[#1b5e20] mb-4 font-sans"
//           >
...
//           <motion.p
//             variants={itemVariants}
//             className="text-2xl md:text-3xl text-[#2d3748] leading-relaxed font-light relative z-10 px-8 mb-12 border-b-2 border-[#e8f5e8] pb-10 font-sans"
//           >
//             To empower Indian agriculture through{" "}
...
//             ensuring prosperity for every farmer.
//           </motion.p>
//         </div>
...
//                 {value.title}
//               </h3>
//               <p className="text-[#4a5568] text-lg font-sans">{value.text}</p>
//             </motion.div>
//           ))}
//         </div>
//       </motion.section>

//       {/* Comprehensive Crop Care Section (Unchanged) */}
//       <motion.section
...
//             >
//               <h3 className="text-lg font-semibold uppercase text-[#4caf50] mb-3 tracking-widest font-sans">
//                 Solutions for Every Stage
//               </h3>
//               <h2 className="text-4xl md:text-5xl font-bold text-[#1b5e20] mb-6 font-sans leading-tight">
//                 Comprehensive Crop Care Products for Maximum Yield
//               </h2>
...
//                 solutions—including specialized Insecticides, Herbicides,
//                 Fungicides, and Growth Regulators—that ensure crop health and
//                 significantly boost farmer productivity.
//               </p>
//               <Link
//                 to="/products"
//                 className="bg-[#1b5e20] text-white px-8 py-4 rounded-full font-semibold
//                             hover:bg-[#2e7d32] transition-colors duration-300 inline-flex items-center shadow-lg font-sans text-lg"
//               >
...
//             {/* Image/Visual: Focus on Product/Crop Health */}
//             <motion.div
...
//                 style={{
//                   backgroundImage: `url('https://placehold.co/800x600/1b5e20/ffffff?text=Product+Range')`,
//                 }}
//               >
...
//       {/* **MODIFIED PRODUCT RANGE SECTION (Non-Paginated)** */}
...
//             <motion.h2
//               variants={itemVariants}
//               className="text-4xl md:text-5xl font-bold text-[#1b5e20] mb-4 font-sans"
//             >
//               Our Specialized Product Range
//             </motion.h2>
//             <motion.p
//               variants={itemVariants}
//               className="text-2xl text-[#4a5568] max-w-3xl mx-auto font-sans"
//             >
...
//           {/* Product Grid Section - Renders ALL cards */}
//           <div className="relative max-w-7xl mx-auto">
//             <motion.div
//               // Removed pagination animation keys and props
//               className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-8" // Increased gap for better spacing
//               initial="hidden"
//               whileInView="visible"
//               viewport={{ once: true, amount: 0.1 }}
//               variants={containerVariants} // Use containerVariants for the grid
//             >
//               {/* Map directly over the full categoryData array */}
//               {categoryData.map((section) => (
//                 <CategoryCard key={section.category} {...section} />
//               ))}
//             </motion.div>

//             {/* REMOVED: Previous/Next buttons and pagination dots */}
//           </div>
//         </motion.div>
//       </section>

//       {/* Mission & Vision Section (Unchanged) */}
//       <section className="relative py-20 bg-gradient-to-br from-[#f0f9f0] to-[#e1f5e1] overflow-hidden font-sans">
//         <div className="absolute inset-0">
//           {[...Array(8)].map((_, i) => (
//             <motion.div
//               key={i}
//               className="absolute text-[#4caf50]/20"
//               animate={{
//                 y: [0, -30, 0],
//                 rotate: [0, 180, 360],
//               }}
...
//           >
//             <motion.div
//               className="inline-flex items-center gap-2 bg-white px-6 py-3 rounded-full shadow-lg mb-6 border border-[#4caf50]/30 font-sans"
//               whileHover={{ scale: 1.05 }}
//             >
//               <FaBullseye className="text-[#1b5e20] text-xl" />
//               <span className="text-[#1b5e20] font-semibold text-xl font-sans">
//                 Our Mission
//               </span>
//             </motion.div>

//             <h2 className="text-4xl md:text-5xl font-bold text-[#1b5e20] mb-6 font-sans">
//               Growing Excellence,
//               <br />
//               <span className="bg-gradient-to-r from-[#1b5e20] to-[#4caf50] bg-clip-text text-transparent font-sans">
//                 Protecting Harvests
//               </span>
//             </h2>
//           </motion.div>
...
//             whileInView={{ opacity: 1, scale: 1 }}
//             viewport={{ once: true }}
//             className="bg-white/80 backdrop-blur-lg rounded-2xl p-10 shadow-2xl border border-[#4caf50]/20 mb-8 font-sans"
//           >
//             <motion.div
//               className="w-20 h-20 bg-gradient-to-br from-[#1b5e20] to-[#4caf50] rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-lg"
//               animate={{ y: [0, -5, 0] }}
...
//             <motion.h3
//               className="text-3xl md:text-4xl font-bold text-[#1b5e20] mb-8 leading-tight italic font-sans"
//               initial={{ opacity: 0 }}
...
//               {[
//                 { icon: FaCheck, text: "Quality", color: "#1b5e20" },
//                 { icon: FaLeaf, text: "Eco-Safe", color: "#2e7d32" },
//                 { icon: FaChartLine, text: "Better Yield", color: "#4caf50" },
//                 { icon: FaRupeeSign, text: "Farmer Income", color: "#388e3c" },
//               ].map((item, index) => (
//                 <motion.div
//                   key={index}
//                   className="flex flex-col items-center p-5 bg-[#f0f9f0] rounded-xl border border-[#4caf50]/20 font-sans"
//                   initial={{ opacity: 0, y: 20 }}
//                   whileInView={{ opacity: 1, y: 0 }}
//                   viewport={{ once: true }}
//                   transition={{ delay: 0.4 + index * 0.1 }}
//                   whileHover={{ scale: 1.05, backgroundColor: "#e1f5e1" }}
//                 >
...
//                     />
//                   </div>
//                   <span className="text-[#1b5e20] font-medium text-lg font-sans">
//                     {item.text}
//                   </span>
//                 </motion.div>
//               ))}
...
//       onHoverStart={() => setIsHovered(true)}
//       onHoverEnd={() => setIsHovered(false)}
//       className="relative rounded-xl shadow-xl p-8 bg-white border border-gray-100 flex flex-col items-center text-center min-h-[450px] overflow-hidden overflow-x-hidden font-sans"
//       whileHover={{ y: -5, boxShadow: "0 15px 30px -5px rgba(0, 0, 0, 0.15)" }}
//       transition={{ type: "spring", stiffness: 300 }}
//       variants={itemVariants} // Added variants here for stagger animation
//     >
...
//       {/* About Section (Unchanged) */}
//       <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden bg-gradient-to-br from-[#d4edda] via-[#c8efd4] to-[#b5e8b5] font-sans">
//         {/* New Animated Background Elements (Unchanged) */}
//         <div className="absolute inset-0 z-0 overflow-hidden">
...
//         <div className="relative z-10 container mx-auto px-4 sm:px-6 max-w-6xl">
//           <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12">
//             {/* Left Side - Visual Element with New Animation */}
//             <motion.div
//               className="lg:w-2/5 flex justify-center lg:justify-start mb-8 lg:mb-0"
//               initial="hidden"
//               whileInView="visible"
...
//               <motion.p
//                 variants={itemVariants}
//                 className="text-base sm:text-lg md:text-xl text-[#1b5e20] mb-8 md:mb-10 leading-relaxed font-semibold  font-sans"
//                 initial={{ opacity: 0, x: -20 }}
//                 animate={{ opacity: 1, x: 0 }}
//                 transition={{ duration: 0.8, delay: 0.6 }}
//               >
...
//           <motion.h2
//             variants={itemVariants}
//             className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl  font-bold text-[#1b5e20] mb-4 font-sans"
//           >
//             Our Vision
//           </motion.h2>
...
//               transition={{ duration: 0.8, delay: 0.3 }}
//             >
//               <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#1b5e20] mb-6 font-sans leading-tight">
//                 Comprehensive Crop Care Products for Maximum Yield
//               </h2>
//               <p className="text-xl text-[#2d3748] mb-8 leading-relaxed font-sans">
//                 Pestigrow offers a powerful portfolio of agricultural products,
...
//             <motion.h3
//               className="text-3xl md:text-4xl font-bold text-[#1b5e20] mb-8 leading-tight  font-sans"
//               initial={{ opacity: 0 }}
//               whileInView={{ opacity: 1 }}
//               viewport={{ once: true }}
//               transition={{ delay: 0.3 }}
...
const CategoryCard = ({ title, description, category, iconImage, color }) => {
  ...
  return (
    ...
    >
      ...
      <p
        // PARAGRAPH: text-base
        className="text-lg min-h-30  text-[#4a5568] mb-8 mx-1 flex-grow font-sans"
      >
        {description}
      </p>
...
                         radial-gradient(circle at 50% 20%, #4caf50 1px, transparent 1px)`,
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 max-w-6xl">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12">
            {/* Left Side - Visual Element with New Animation (Unchanged) */}
            <motion.div
              className="lg:w-2/5 flex justify-center lg:justify-start mb-8 lg:mb-0"
              initial="hidden"
              whileInView="visible"
            ...
            >
              ...
              <motion.p
                variants={itemVariants}
                // PARAGRAPH: text-base (Keeping it bold/semibold for impact)
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <motion.p
            variants={itemVariants}
            // PARAGRAPH: text-base (keeping it large for emphasis as a vision statement)
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto font-sans">
          {[
            ...
            >
              ...
              <p
                // PARAGRAPH: text-base
                className="text-lg text-[#4a5568] font-sans"
              >
                {value.text}
              </p>
            </motion.div>
      ...
      {/* Comprehensive Crop Care Section */}
      <motion.section
        className="py-20 bg-[#e8f5e8] font-sans"
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 text-left">
            ...
            >
              ...
              <p
                // PARAGRAPH: text-base
                className="text-xl text-[#2d3748] mb-8 leading-relaxed font-sans"
              >
                Pestigrow offers a powerful portfolio of agricultural products,
                meticulously developed to protect your crops from every threat,
                from seed to harvest. We deliver high-efficacy, science-backed
