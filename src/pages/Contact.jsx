...
//     const companyEmail = "pestigrowcropsciene@gmail.com";
...
//     phone: "8962303996",
//     email: "pestigrowcropsciene@gmail.com",
...
//               <button
//                 type="submit"
//                 className={`w-full ${accentBg} text-white px-8 py-3 rounded-full font-bold text-base md:text-lg bg-[#0b370e] transition duration-300 shadow-md inline-flex items-center justify-center font-sans`}
//               >
...
//                 Start Chatting <FaArrowRight className="ml-2 w-4 h-4" />
//               </div>
//             </div>
//           </div>
//         </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            >
              ...
              <div>
                <h3
                  classN  ame={`text-lg md:text-xl font-bold ${primaryColor} mb-1`}
                >
                  Registered Office
                </h3>
                <p className="text-gray-600 text-base md:text-lg group-hover:text-[#2e7d32]">
