// // src/components/layout/Footer.jsx (Direct Styling)
...
//           <div className="flex space-x-4 mt-4 text-[#4caf50]">
...
import React from "react";
import { Link } from "react-router-dom";
import { FaFacebook, FaInstagram, FaLinkedin } from "react-icons/fa"; // Import Facebook, Instagram, and LinkedIn icons
import { IMAGES } from "../assets/Images";
        ...
        <div className="col-span-full md:col-span-1">
          <Link to="/" className="flex items-center space-x-2 mb-4">
            <img
              src={IMAGES.logo}
              alt="Pestigrow Logo"
              // Added filter invert to ensure the logo is visible on the dark green background
